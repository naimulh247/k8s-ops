...
type GhostStatus struct {
	...
	// conditions represent the current state of the Ghost resource.
...
type Ghost struct {
	...
	// spec defines the desired state of Ghost
	// +required
	Spec GhostSpec `json:"spec"`

	// status defines the observed state of Ghost
	// +optional
	Status GhostStatus `json:"status,omitzero"`
}
